 ...
 * Версия: 1.0.84 (28.05.2013 13:17 +0400)
...
if (typeof thirdparty_shared == "undefined") {
	...
	(function(ts){
		...
		script.src = "/thirdparty-v2/_core/core.js?ver=1.0.25";
...
var __name_lib		=	"lib";
var __name_pu		=	"pu";
var __name_script	=	"photo-talisman.js";
...
var _photo_talisman = function() {
	...
	this._config			=	{
		...
		noteConf:				{
			html:				"Уважаемые читатели! Мы предлагаем вам нарядиться одним из животных, ставших талисманами Олимпийских игр 2014 года – Леопардом, Белым медведем или Зайцем. Сфотографируйтесь в новом образе и выкладывайте свой снимок на наш сайт. Поддержите наших спортсменов на будущих Играх. Лучшие фотографии обязательно появятся в газете Metro.",
		},
		ratedConf:				{
			cols:				4,
			display:			"runtime",//inblock
			imgHeight:			"100px",//150px
			inblockId:			__name_this + "-talisman-rated",
			inblockSearchCnt:	0,
		...
		termsConf:				{
			html:				"",
			loadFromBlock:		true,
			loadFromBlockId:	"photo-talisman-terms"
		},
		showForm:				true,
		showLast:				true,
		showNote:				true,
...
_photo_talisman.prototype._init = function(last) {
	...
	if (!this.elCss) {
		var src = this.plCore.baseDir() + "_plugins/" + this._name + "/" + this._name + ".css?ver=1.0.84";
...
_photo_talisman.prototype.actionDataSave = function() {
...
_photo_talisman.prototype.actionImgUpload = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_talisman.prototype.actionListInitial = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_talisman.prototype.actionListLast = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_talisman.prototype.actionListLastMore = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_talisman.prototype.actionListMore = function(dir) {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_talisman.prototype.actionListRated = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_talisman.prototype.actionLoveChange = function(id, c) {
...
_photo_talisman.prototype.actionLoveFbSave = function(id, c) {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_talisman.prototype.actionUserGet = function() {
};
_photo_talisman.prototype.DOMForm = function() {
...
_photo_talisman.prototype.DOMGallery = function() {
	//слайдер
...
_photo_talisman.prototype.DOMLast = function() {
...
_photo_talisman.prototype.DOMLastItem = function(i, pos) {
...
_photo_talisman.prototype.DOMRated = function(d) {
...
_photo_talisman.prototype.DOMRatedItem = function(i, pos) {
	i.dom = document.createElement("DIV");
...
_photo_talisman.prototype.DOMRatedSearch = function() {
...
_photo_talisman.prototype.DOMSocBtns = function(i) {
	//кнопки голосования
	//VK
...
_photo_talisman.prototype.formFieldsEmpty = function() {
...
_photo_talisman.prototype.formFieldsCheck = function() {
	for (var c in this._fields) {
		if (!this._fields.hasOwnProperty(c)) continue;
...
_photo_talisman.prototype.formInpFileRecreate = function() {
...
_photo_talisman.prototype.listLastRepose = function() {
...
_photo_talisman.prototype.listRatedRepose = function() {
...
_photo_talisman.prototype.onAction = function(req) {
...
_photo_talisman.prototype.onBlurFormField = function(i) {
	if (i.dom.value == "") i.dom.value = i.valdef;
};
_photo_talisman.prototype.onClickBtnLastMore = function() {
	this.elLastMoreBtn.style.display = "none";
	this.elLastMoreWait.style.display = "block";
	this.actionListLastMore();
};
_photo_talisman.prototype.onClickChbTerms = function() {
...
_photo_talisman.prototype.onClickFormBtnSend = function() {
...
_photo_talisman.prototype.onClickFormFileSelect = function() {
...
_photo_talisman.prototype.onFocusFormField = function(i) {
	if (i.dom.value == i.valdef) i.dom.value = "";
};
_photo_talisman.prototype.onGalleriaInstance = function(i) {
...
_photo_talisman.prototype.onGalleriaReady = function() {
...
_photo_talisman.prototype.onGalleryVote = function() {
};
_photo_talisman.prototype.onPlayStop = function(e) {
	var uri = "";
	if (this.plCore._url.segments[0])
		uri = this.plCore._url.segments.join("/");
...
_photo_talisman.prototype.onFBLiked = function(url) {
...
_photo_talisman.prototype.onFBUnliked = function(url) {
	var p = this.plCore.urlParse(url);
	if (typeof p.params["id"] != "undefined") {
		var id = parseInt(p.params["id"], 10);
...
_photo_talisman.prototype.onVKCount = function(id, r) {
...
if (thirdparty_shared.core._loaded) {
	thirdparty_shared.core._obj.pluginReg(new _photo_talisman(), true);
} else {
	var w = {};
	w.init = true;
	w.obj = new _photo_talisman();
