 ...
 * Версия: 1.0.76 (15.05.2013 16:21 +0400)
...
var __name_lib		=	"lib";
var __name_pu		=	"pu";
var __name_script	=	"photo-zippo.js";
...
var _photo_zippo = function() {
	...
	this._config			=	{
		...
		ratedConf:				{
			...
			imgHeight:			"150px",
			inblockId:			__name_this + "-zippo-rated",
			inblockSearchCnt:	0,
		...
		termsConf:				{
			...
			note:				"Если вы обнаружили фото со звездой в своем архиве - поделитесь им!. Загрузите изображение со своего компьютера, напишите, с какой звездой, когда и при каких обстоятельствах вы сфотографировались и придумайте к фото интересный заголовок. Лучшие снимки, как всегда, будут опубликованы в газете Metro.",
			html:				"",
			loadFromBlock:		true,
			loadFromBlockId:	"photo-zippo-terms"
		},
		showLast:				false,
		showRated:				true,
		showTerms:				true
...
_photo_zippo.prototype._init = function(last) {
	...
	if (!this.elCss) {
		var src = this.plCore.baseDir() + "_plugins/" + this._name + "/" + this._name + ".css?ver=1.0.76";
...
_photo_zippo.prototype.actionDataSave = function() {
...
_photo_zippo.prototype.actionImgUpload = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_zippo.prototype.actionListInitial = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_zippo.prototype.actionListLast = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_zippo.prototype.actionListLastMore = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_zippo.prototype.actionListMore = function(dir) {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_zippo.prototype.actionListRated = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_zippo.prototype.actionLoveChange = function(id, c) {
...
_photo_zippo.prototype.actionLoveFbSave = function(id, c) {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_zippo.prototype.actionUserGet = function() {
};
_photo_zippo.prototype.DOMForm = function() {
	...
	if (this._config.showTerms && ((this._config.termsConf.display == "block") || (this._config.termsConf.display == "both"))) {
		...
		el.innerHTML = this._config.termsConf.note;
		this.elFormInfo.appendChild(el);
	}
...
_photo_zippo.prototype.DOMGallery = function() {
	//слайдер
...
_photo_zippo.prototype.DOMLast = function() {
...
_photo_zippo.prototype.DOMLastItem = function(i, pos) {
...
_photo_zippo.prototype.DOMRated = function(d) {
...
_photo_zippo.prototype.DOMRatedSearch = function() {
...
_photo_zippo.prototype.DOMRatedItem = function(i, pos) {
	i.dom = document.createElement("DIV");
	i.dom.className = "column-item";
	var el = document.createElement("DIV");
...
_photo_zippo.prototype.DOMSocBtns = function(i) {
	//кнопки голосования
	//VK
...
_photo_zippo.prototype.formFieldsEmpty = function() {
...
_photo_zippo.prototype.formFieldsCheck = function() {
	for (var c in this._fields) {
		if (!this._fields.hasOwnProperty(c)) continue;
...
_photo_zippo.prototype.formInpFileRecreate = function() {
...
_photo_zippo.prototype.listLastRepose = function() {
...
_photo_zippo.prototype.listRatedRepose = function() {
...
_photo_zippo.prototype.onAction = function(req) {
...
_photo_zippo.prototype.onBlurFormField = function(i) {
	if (i.dom.value == "") i.dom.value = i.valdef;
};
_photo_zippo.prototype.onClickBtnLastMore = function() {
	this.elLastMoreBtn.style.display = "none";
	this.elLastMoreWait.style.display = "block";
	this.actionListLastMore();
};
_photo_zippo.prototype.onClickChbTerms = function() {
...
_photo_zippo.prototype.onClickFormBtnSend = function() {
...
_photo_zippo.prototype.onClickFormFileSelect = function() {
...
_photo_zippo.prototype.onFocusFormField = function(i) {
	if (i.dom.value == i.valdef) i.dom.value = "";
};
_photo_zippo.prototype.onGalleriaInstance = function(i) {
...
_photo_zippo.prototype.onGalleriaReady = function() {
...
_photo_zippo.prototype.onGalleryVote = function() {
};
_photo_zippo.prototype.onPlayStop = function(e) {
	var uri = "";
	if (this.plCore._url.segments[0])
		uri = this.plCore._url.segments.join("/");
...
_photo_zippo.prototype.onFBLiked = function(url) {
...
_photo_zippo.prototype.onFBUnliked = function(url) {
	var p = this.plCore.urlParse(url);
	if (typeof p.params["id"] != "undefined") {
		var id = parseInt(p.params["id"], 10);
...
_photo_zippo.prototype.onVKCount = function(id, r) {
...
if (thirdparty_shared.core._loaded) {
	thirdparty_shared.core._obj.pluginReg(new _photo_zippo(), true);
} else {
	var w = {};
	w.init = true;
	w.obj = new _photo_zippo();
