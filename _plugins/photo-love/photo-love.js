 ...
 * Версия: 1.0.84 (15.05.2013 13:17 +0400)
...
var __name_lib		=	"lib";
var __name_pu		=	"pu";
var __name_script	=	"photo-love.js";
...
var _photo_love = function() {
	...
	this._config			=	{
		...
		noteConf:				{
			html:				"Уважаемые читатели! А вы не хотите еще раз признаться своей половинке в любви? Тогда выкладывайте свои фотографии на наш сайт.<br /><br />Не забудьте написать пару ласковых фраз для любимого человека! У вас появилась прекрасная возможность признаться друг другу в любви через газету Metro.",
		},
		ratedConf:				{
			cols:				4,
			display:			"runtime",//inblock
			imgHeight:			"100px",//150px
			inblockId:			__name_this + "-love-rated",
			inblockSearchCnt:	0,
		...
		termsConf:				{
			html:				"",
			loadFromBlock:		true,
			loadFromBlockId:	"photo-love-terms"
		},
		showForm:				true,
		showLast:				true,
		showNote:				true,
...
_photo_love.prototype._init = function(last) {
...
_photo_love.prototype.actionDataSave = function() {
...
_photo_love.prototype.actionImgUpload = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_love.prototype.actionListInitial = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_love.prototype.actionListLast = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_love.prototype.actionListLastMore = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_love.prototype.actionListMore = function(dir) {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_love.prototype.actionListRated = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_love.prototype.actionLoveChange = function(id, c) {
...
_photo_love.prototype.actionLoveFbSave = function(id, c) {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_love.prototype.actionUserGet = function() {
};
_photo_love.prototype.DOMForm = function() {
...
_photo_love.prototype.DOMGallery = function() {
	//слайдер
...
_photo_love.prototype.DOMLast = function() {
...
_photo_love.prototype.DOMLastItem = function(i, pos) {
...
_photo_love.prototype.DOMRated = function(d) {
...
_photo_love.prototype.DOMRatedItem = function(i, pos) {
	i.dom = document.createElement("DIV");
...
_photo_love.prototype.DOMRatedSearch = function() {
...
_photo_love.prototype.DOMSocBtns = function(i) {
	//кнопки голосования
	//VK
...
_photo_love.prototype.formFieldsEmpty = function() {
...
_photo_love.prototype.formFieldsCheck = function() {
	for (var c in this._fields) {
		if (!this._fields.hasOwnProperty(c)) continue;
...
_photo_love.prototype.formInpFileRecreate = function() {
...
_photo_love.prototype.listLastRepose = function() {
...
_photo_love.prototype.listRatedRepose = function() {
...
_photo_love.prototype.onAction = function(req) {
...
_photo_love.prototype.onBlurFormField = function(i) {
	if (i.dom.value == "") i.dom.value = i.valdef;
};
_photo_love.prototype.onClickBtnLastMore = function() {
	this.elLastMoreBtn.style.display = "none";
	this.elLastMoreWait.style.display = "block";
	this.actionListLastMore();
};
_photo_love.prototype.onClickChbTerms = function() {
...
_photo_love.prototype.onClickFormBtnSend = function() {
...
_photo_love.prototype.onClickFormFileSelect = function() {
...
_photo_love.prototype.onFocusFormField = function(i) {
	if (i.dom.value == i.valdef) i.dom.value = "";
};
_photo_love.prototype.onGalleriaInstance = function(i) {
...
_photo_love.prototype.onGalleriaReady = function() {
...
_photo_love.prototype.onGalleryVote = function() {
};
_photo_love.prototype.onPlayStop = function(e) {
	var uri = "";
	if (this.plCore._url.segments[0])
		uri = this.plCore._url.segments.join("/");
...
_photo_love.prototype.onFBLiked = function(url) {
...
_photo_love.prototype.onFBUnliked = function(url) {
	var p = this.plCore.urlParse(url);
	if (typeof p.params["id"] != "undefined") {
		var id = parseInt(p.params["id"], 10);
...
_photo_love.prototype.onVKCount = function(id, r) {
...
if (thirdparty_shared.core._loaded) {
	thirdparty_shared.core._obj.pluginReg(new _photo_love(), true);
} else {
	var w = {};
	w.init = true;
	w.obj = new _photo_love();
