...
var __name_lib		=	"lib";
var __name_pu		=	"pu";
var __name_script	=	"photo-antirek-nar.js";
...
var _photo_antirek_nar = function() {
	...
	this._config			=	{
		...
		ratedConf:				{
			...
			inblockId:			__name_this + "-antirek-nar-rated",
			inblockSearchCnt:	0,
		...
		termsConf:				{
			html:				"",
			loadFromBlock:		true,
			loadFromBlockId:	"photo-antirek-nar-terms"
		},
		showForm:				true,
		showLast:				true,
		showNote:				true,
...
_photo_antirek_nar.prototype._init = function(last) {
...
_photo_antirek_nar.prototype.actionDataSave = function() {
...
_photo_antirek_nar.prototype.actionImgUpload = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_antirek_nar.prototype.actionListInitial = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_antirek_nar.prototype.actionListLast = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_antirek_nar.prototype.actionListLastMore = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_antirek_nar.prototype.actionListMore = function(dir) {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_antirek_nar.prototype.actionListRated = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_antirek_nar.prototype.actionLoveChange = function(id, c) {
...
_photo_antirek_nar.prototype.actionLoveFbSave = function(id, c) {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_antirek_nar.prototype.actionUserGet = function() {
};
_photo_antirek_nar.prototype.DOMForm = function() {
...
_photo_antirek_nar.prototype.DOMFormFieldsCustom = function() {
...
_photo_antirek_nar.prototype.DOMGallery = function() {
	//слайдер
...
_photo_antirek_nar.prototype.DOMLast = function() {
...
_photo_antirek_nar.prototype.DOMLastItem = function(i, pos) {
...
_photo_antirek_nar.prototype.DOMRated = function(d) {
...
_photo_antirek_nar.prototype.DOMRatedItem = function(i, pos) {
	i.dom = document.createElement("DIV");
...
_photo_antirek_nar.prototype.DOMRatedSearch = function() {
...
_photo_antirek_nar.prototype.DOMSocBtns = function(i) {
	//кнопки голосования
	//VK
...
_photo_antirek_nar.prototype.formFieldsCustomFetch = function(pos) {
...
_photo_antirek_nar.prototype.formFieldsEmpty = function() {
...
_photo_antirek_nar.prototype.formFieldsCheck = function() {
	for (var c in this._fields) {
		if (!this._fields.hasOwnProperty(c)) continue;
...
_photo_antirek_nar.prototype.formInpFileRecreate = function() {
...
_photo_antirek_nar.prototype.listLastRepose = function() {
...
_photo_antirek_nar.prototype.listRatedRepose = function() {
...
_photo_antirek_nar.prototype.onAction = function(req) {
...
_photo_antirek_nar.prototype.onBlurFormField = function(i) {
	if (i.dom.value == "") i.dom.value = i.valdef;
};
_photo_antirek_nar.prototype.onClickBtnLastMore = function() {
	this.elLastMoreBtn.style.display = "none";
	this.elLastMoreWait.style.display = "block";
	this.actionListLastMore();
};
_photo_antirek_nar.prototype.onClickChbTerms = function() {
...
_photo_antirek_nar.prototype.onClickFormBtnSend = function() {
...
_photo_antirek_nar.prototype.onClickFormFileSelect = function() {
...
_photo_antirek_nar.prototype.onFocusFormField = function(i) {
	if (i.dom.value == i.valdef) i.dom.value = "";
};
_photo_antirek_nar.prototype.onGalleriaInstance = function(i) {
...
_photo_antirek_nar.prototype.onGalleriaReady = function() {
...
_photo_antirek_nar.prototype.onGalleryVote = function() {
};
_photo_antirek_nar.prototype.onPlayStop = function(e) {
	var uri = "";
	if (this.plCore._url.segments[0])
		uri = this.plCore._url.segments.join("/");
...
_photo_antirek_nar.prototype.onFBLiked = function(url) {
...
_photo_antirek_nar.prototype.onFBUnliked = function(url) {
	var p = this.plCore.urlParse(url);
	if (typeof p.params["id"] != "undefined") {
		var id = parseInt(p.params["id"], 10);
...
_photo_antirek_nar.prototype.onVKCount = function(id, r) {
...
if (thirdparty_shared.core._loaded) {
	thirdparty_shared.core._obj.pluginReg(new _photo_antirek_nar(), true);
} else {
	var w = {};
	w.init = true;
	w.obj = new _photo_antirek_nar();
