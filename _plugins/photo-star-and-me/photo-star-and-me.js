 ...
 * Версия: 1.0.57 (24.04.2013 17:34 +0400)
...
if (typeof thirdparty_shared == "undefined") {
	...
	(function(ts){
		...
		script.src = "/thirdparty-v2/_core/core.js?ver=1.0.13";
...
var __name_lib		=	"lib";
var __name_script	=	"photo-star-and-me.js";
...
var _photo_star_and_me = function() {
	...
	*/
	this._fields			=	{
		...
		desc:	{
			...
			valdef:		"Опишите фото в соответствии с правилами конкурса",
		}
	};
	this._lastItems			=	[];
	this._lastClrs			=	[];
...
_photo_star_and_me.prototype._init = function(last) {
	...
	if (!this.elCss) {
		var src = this.plCore.baseDir() + "_plugins/" + this._name + "/" + this._name + ".css?ver=1.0.57";
	...
	if (!this.plGalleria) {
		this.plGalleria = this.plCore.pluginGet(__name_galleria, "ver=1.0.2");
		if (!this.plGalleria) {
			if (last) {
				this._inited = true;
	...
	if (this._galleriaStart) this.actionListLast();
	return true;
};
_photo_star_and_me.prototype.actionDataSave = function() {
...
_photo_star_and_me.prototype.actionImgUpload = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_star_and_me.prototype.actionListInitial = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_star_and_me.prototype.actionListLast = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_star_and_me.prototype.actionListLastMore = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_star_and_me.prototype.actionListMore = function(dir) {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_star_and_me.prototype.actionListRated = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_star_and_me.prototype.actionLoveChange = function(id, c) {
...
_photo_star_and_me.prototype.actionLoveFbSave = function(id, c) {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_star_and_me.prototype.actionUserGet = function() {
};
_photo_star_and_me.prototype.DOMForm = function() {
	this.elForm = document.createElement("DIV");
	this.elForm.className = "form";
	...
	el.innerHTML = "Если вы обнаружили фото со звездой в своем архиве - поделитесь им!. Загрузите изображение со своего компьютера, напишите, с какой звездой, когда и при каких обстоятельствах вы сфотографировались и придумайте к фото интересный заголовок. Лучшие снимки, как всегда, будут опубликованы в газете Metro.";
	this.elFormInfo.appendChild(el);
	...
	el = document.createElement("DIV");
	el.className = "prompt";
	el.innerHTML = "Прислать свое фото";
	...
	this.elFormDataFCont.innerHTML = "Загрузить фото с компьютера";
	...
	this._user.terms.dom.checked = false;
...
_photo_star_and_me.prototype.DOMGallery = function() {
	//слайдер
...
_photo_star_and_me.prototype.DOMLast = function() {
...
_photo_star_and_me.prototype.DOMLastItem = function(i, pos) {
...
_photo_star_and_me.prototype.DOMRated = function() {
	this.elRated = document.createElement("DIV");
	this.elRated.className = "rated-items";
	this.elRated.style.display = "none";
	this.elMain.appendChild(this.elRated);
	var el = document.createElement("DIV");
	el.className = "rated-title";
	el.innerHTML = "Самое популярное";
...
_photo_star_and_me.prototype.DOMRatedItem = function(i, pos) {
	i.dom = document.createElement("DIV");
	i.dom.className = "column-item";
	var el = document.createElement("DIV");
...
_photo_star_and_me.prototype.DOMSocBtns = function(i) {
	//кнопки голосования
	//VK
...
_photo_star_and_me.prototype.formFieldsEmpty = function() {
...
_photo_star_and_me.prototype.formFieldsCheck = function() {
	for (var c in this._fields) {
		if (!this._fields.hasOwnProperty(c)) continue;
...
_photo_star_and_me.prototype.formInpFileRecreate = function() {
...
_photo_star_and_me.prototype.listLastRepose = function() {
...
_photo_star_and_me.prototype.listRatedRepose = function() {
	...
	for (var c in this._ratedItems) {
		...
		this._ratedItems[c].dom.className = "column-item" + (cnt > 1 ? (" need-margin p" + cnt) : "");
		cnt++;
		if (cnt == 5) {
			cnt = 1;
			var ord = 1 + parseInt(c, 10);
...
_photo_star_and_me.prototype.onAction = function(req) {
...
_photo_star_and_me.prototype.onBlurFormField = function(i) {
	if (i.dom.value == "") i.dom.value = i.valdef;
};
_photo_star_and_me.prototype.onClickBtnLastMore = function() {
	this.elLastMoreBtn.style.display = "none";
	this.elLastMoreWait.style.display = "block";
	this.actionListLastMore();
};
_photo_star_and_me.prototype.onClickFormBtnSend = function() {
...
_photo_star_and_me.prototype.onClickFormFileSelect = function() {
...
_photo_star_and_me.prototype.onFocusFormField = function(i) {
	if (i.dom.value == i.valdef) i.dom.value = "";
};
_photo_star_and_me.prototype.onGalleriaInstance = function(i) {
...
_photo_star_and_me.prototype.onGalleriaReady = function() {
...
_photo_star_and_me.prototype.onGalleryVote = function() {
};
_photo_star_and_me.prototype.onPlayStop = function(e) {
	var uri = "";
	if (this.plCore._url.segments[0])
		uri = this.plCore._url.segments.join("/");
...
_photo_star_and_me.prototype.onFBLiked = function(url) {
...
_photo_star_and_me.prototype.onFBUnliked = function(url) {
	var p = this.plCore.urlParse(url);
	if (typeof p.params["id"] != "undefined") {
		var id = parseInt(p.params["id"], 10);
...
_photo_star_and_me.prototype.onVKCount = function(id, r) {
...
if (thirdparty_shared.core._loaded) {
	thirdparty_shared.core._obj.pluginReg(new _photo_star_and_me(), true);
} else {
	var w = {};
	w.init = true;
	w.obj = new _photo_star_and_me();
