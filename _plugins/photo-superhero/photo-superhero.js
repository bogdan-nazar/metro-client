 ...
 * Версия: 1.1.1 (11.06.2013 16:45 +0400)
...
var __name_lib		=	"lib";
var __name_pu		=	"pu";
var __name_script	=	"photo-superhero.js";
...
var _photo_superhero = function() {
	...
	this._config			=	{
		...
		noteConf:				{
			html:				"Загрузи свое фото в костюме супергероя, на котором ты совершаешь героический поступок. Напиши, что, где и когда ты сделал и о твоем подвиге узнает вся Россия.<br /><br />Все присланные нам кадры мы опубликуем в последующих выпусках газеты.",
		},
		ratedConf:				{
			cols:				4,
			display:			"runtime",//inblock
			imgHeight:			"100px",//150px
			inblockId:			__name_this + "-superhero-rated",
			inblockSearchCnt:	0,
		...
		termsConf:				{
			html:				"",
			loadFromBlock:		true,
			loadFromBlockId:	"photo-superhero-terms"
		},
		showForm:				true,
		showLast:				true,
		showNote:				true,
	...
	this._fields			=	{
		...
		title:	{
			dom:		null,
			msg:		"Введите небольшое описание своего подвига!",
			valdef:		"Опиши подвиг, который ты совершил"
		},
		desc:	{
			dom:		null,
...
_photo_superhero.prototype._init = function(last) {
	...
	if (!this.elCss) {
		var src = this.plCore.baseDir() + "_plugins/" + this._name + "/" + this._name + ".css?ver=1.1.1";
...
_photo_superhero.prototype.actionDataSave = function() {
...
_photo_superhero.prototype.actionImgUpload = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_superhero.prototype.actionListInitial = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_superhero.prototype.actionListLast = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_superhero.prototype.actionListLastMore = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_superhero.prototype.actionListMore = function(dir) {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_superhero.prototype.actionListRated = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_superhero.prototype.actionLoveChange = function(id, c) {
...
_photo_superhero.prototype.actionLoveFbSave = function(id, c) {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_superhero.prototype.actionUserGet = function() {
};
_photo_superhero.prototype.DOMForm = function() {
...
_photo_superhero.prototype.DOMFormFieldsCustom = function() {
...
_photo_superhero.prototype.DOMGallery = function() {
	//слайдер
...
_photo_superhero.prototype.DOMLast = function() {
...
_photo_superhero.prototype.DOMLastItem = function(i, pos) {
...
_photo_superhero.prototype.DOMRated = function(d) {
...
_photo_superhero.prototype.DOMRatedItem = function(i, pos) {
	i.dom = document.createElement("DIV");
...
_photo_superhero.prototype.DOMRatedSearch = function() {
...
_photo_superhero.prototype.DOMSocBtns = function(i) {
	//кнопки голосования
	//VK
...
_photo_superhero.prototype.formFieldsCustomFetch = function(pos) {
...
_photo_superhero.prototype.formFieldsEmpty = function() {
...
_photo_superhero.prototype.formFieldsCheck = function() {
	for (var c in this._fields) {
		if (!this._fields.hasOwnProperty(c)) continue;
...
_photo_superhero.prototype.formInpFileRecreate = function() {
...
_photo_superhero.prototype.listLastRepose = function() {
...
_photo_superhero.prototype.listRatedRepose = function() {
...
_photo_superhero.prototype.onAction = function(req) {
...
_photo_superhero.prototype.onBlurFormField = function(i) {
	if (i.dom.value == "") i.dom.value = i.valdef;
};
_photo_superhero.prototype.onClickBtnLastMore = function() {
	this.elLastMoreBtn.style.display = "none";
	this.elLastMoreWait.style.display = "block";
	this.actionListLastMore();
};
_photo_superhero.prototype.onClickChbTerms = function() {
...
_photo_superhero.prototype.onClickFormBtnSend = function() {
...
_photo_superhero.prototype.onClickFormFileSelect = function() {
...
_photo_superhero.prototype.onFocusFormField = function(i) {
	if (i.dom.value == i.valdef) i.dom.value = "";
};
_photo_superhero.prototype.onGalleriaInstance = function(i) {
...
_photo_superhero.prototype.onGalleriaReady = function() {
...
_photo_superhero.prototype.onGalleryVote = function() {
};
_photo_superhero.prototype.onPlayStop = function(e) {
	var uri = "";
	if (this.plCore._url.segments[0])
		uri = this.plCore._url.segments.join("/");
...
_photo_superhero.prototype.onFBLiked = function(url) {
...
_photo_superhero.prototype.onFBUnliked = function(url) {
	var p = this.plCore.urlParse(url);
	if (typeof p.params["id"] != "undefined") {
		var id = parseInt(p.params["id"], 10);
...
_photo_superhero.prototype.onVKCount = function(id, r) {
...
if (thirdparty_shared.core._loaded) {
	thirdparty_shared.core._obj.pluginReg(new _photo_superhero(), true);
} else {
	var w = {};
	w.init = true;
	w.obj = new _photo_superhero();
