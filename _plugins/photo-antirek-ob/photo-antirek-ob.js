...
var __name_lib		=	"lib";
var __name_pu		=	"pu";
var __name_script	=	"photo-antirek-ob.js";
...
var _photo_antirek_ob = function() {
	...
	this._config			=	{
		...
		ratedConf:				{
			...
			inblockId:			__name_this + "-antirek-ob-rated",
			inblockSearchCnt:	0,
		...
		termsConf:				{
			html:				"",
			loadFromBlock:		true,
			loadFromBlockId:	"photo-antirek-ob-terms"
		},
		showForm:				true,
		showLast:				true,
		showNote:				true,
...
_photo_antirek_ob.prototype._init = function(last) {
...
_photo_antirek_ob.prototype.actionDataSave = function() {
...
_photo_antirek_ob.prototype.actionImgUpload = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_antirek_ob.prototype.actionListInitial = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_antirek_ob.prototype.actionListLast = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_antirek_ob.prototype.actionListLastMore = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_antirek_ob.prototype.actionListMore = function(dir) {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_antirek_ob.prototype.actionListRated = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_antirek_ob.prototype.actionLoveChange = function(id, c) {
...
_photo_antirek_ob.prototype.actionLoveFbSave = function(id, c) {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_antirek_ob.prototype.actionUserGet = function() {
};
_photo_antirek_ob.prototype.DOMForm = function() {
...
_photo_antirek_ob.prototype.DOMFormFieldsCustom = function() {
...
_photo_antirek_ob.prototype.DOMGallery = function() {
	//слайдер
...
_photo_antirek_ob.prototype.DOMLast = function() {
...
_photo_antirek_ob.prototype.DOMLastItem = function(i, pos) {
...
_photo_antirek_ob.prototype.DOMRated = function(d) {
...
_photo_antirek_ob.prototype.DOMRatedItem = function(i, pos) {
	i.dom = document.createElement("DIV");
...
_photo_antirek_ob.prototype.DOMRatedSearch = function() {
...
_photo_antirek_ob.prototype.DOMSocBtns = function(i) {
	//кнопки голосования
	//VK
...
_photo_antirek_ob.prototype.formFieldsCustomFetch = function(pos) {
...
_photo_antirek_ob.prototype.formFieldsEmpty = function() {
...
_photo_antirek_ob.prototype.formFieldsCheck = function() {
	for (var c in this._fields) {
		if (!this._fields.hasOwnProperty(c)) continue;
...
_photo_antirek_ob.prototype.formInpFileRecreate = function() {
...
_photo_antirek_ob.prototype.listLastRepose = function() {
...
_photo_antirek_ob.prototype.listRatedRepose = function() {
...
_photo_antirek_ob.prototype.onAction = function(req) {
...
_photo_antirek_ob.prototype.onBlurFormField = function(i) {
	if (i.dom.value == "") i.dom.value = i.valdef;
};
_photo_antirek_ob.prototype.onClickBtnLastMore = function() {
	this.elLastMoreBtn.style.display = "none";
	this.elLastMoreWait.style.display = "block";
	this.actionListLastMore();
};
_photo_antirek_ob.prototype.onClickChbTerms = function() {
...
_photo_antirek_ob.prototype.onClickFormBtnSend = function() {
...
_photo_antirek_ob.prototype.onClickFormFileSelect = function() {
...
_photo_antirek_ob.prototype.onFocusFormField = function(i) {
	if (i.dom.value == i.valdef) i.dom.value = "";
};
_photo_antirek_ob.prototype.onGalleriaInstance = function(i) {
...
_photo_antirek_ob.prototype.onGalleriaReady = function() {
...
_photo_antirek_ob.prototype.onGalleryVote = function() {
};
_photo_antirek_ob.prototype.onPlayStop = function(e) {
	var uri = "";
	if (this.plCore._url.segments[0])
		uri = this.plCore._url.segments.join("/");
...
_photo_antirek_ob.prototype.onFBLiked = function(url) {
...
_photo_antirek_ob.prototype.onFBUnliked = function(url) {
	var p = this.plCore.urlParse(url);
	if (typeof p.params["id"] != "undefined") {
		var id = parseInt(p.params["id"], 10);
...
_photo_antirek_ob.prototype.onVKCount = function(id, r) {
...
if (thirdparty_shared.core._loaded) {
	thirdparty_shared.core._obj.pluginReg(new _photo_eda(), true);
} else {
	var w = {};
	w.init = true;
	w.obj = new _photo_eda();
