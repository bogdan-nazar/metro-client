...
var __name_lib		=	"lib";
var __name_pu		=	"pu";
var __name_script	=	"photo-eda.js";
...
var _photo_eda = function() {
	...
	this._config			=	{
		...
		ratedConf:				{
			...
			inblockId:			__name_this + "-eda-rated",
			inblockSearchCnt:	0,
		...
		termsConf:				{
			html:				"",
			loadFromBlock:		true,
			loadFromBlockId:	"photo-eda-terms"
		},
		showForm:				true,
		showLast:				true,
		showNote:				true,
...
_photo_eda.prototype._init = function(last) {
...
_photo_eda.prototype.actionDataSave = function() {
...
_photo_eda.prototype.actionImgUpload = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_eda.prototype.actionListInitial = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_eda.prototype.actionListLast = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_eda.prototype.actionListLastMore = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_eda.prototype.actionListMore = function(dir) {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_eda.prototype.actionListRated = function() {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_eda.prototype.actionLoveChange = function(id, c) {
...
_photo_eda.prototype.actionLoveFbSave = function(id, c) {
	var req = this.plCore.reqXBuild(this);
	req.method = "POST";
	req.json = true;
...
_photo_eda.prototype.actionUserGet = function() {
};
_photo_eda.prototype.DOMForm = function() {
...
_photo_eda.prototype.DOMFormFieldsCustom = function() {
...
_photo_eda.prototype.DOMGallery = function() {
	//слайдер
...
_photo_eda.prototype.DOMLast = function() {
...
_photo_eda.prototype.DOMLastItem = function(i, pos) {
...
_photo_eda.prototype.DOMRated = function(d) {
...
_photo_eda.prototype.DOMRatedItem = function(i, pos) {
	i.dom = document.createElement("DIV");
...
_photo_eda.prototype.DOMRatedSearch = function() {
...
_photo_eda.prototype.DOMSocBtns = function(i) {
	//кнопки голосования
	//VK
...
_photo_eda.prototype.formFieldsCustomFetch = function(pos) {
...
_photo_eda.prototype.formFieldsEmpty = function() {
...
_photo_eda.prototype.formFieldsCheck = function() {
	for (var c in this._fields) {
		if (!this._fields.hasOwnProperty(c)) continue;
...
_photo_eda.prototype.formInpFileRecreate = function() {
...
_photo_eda.prototype.listLastRepose = function() {
...
_photo_eda.prototype.listRatedRepose = function() {
...
_photo_eda.prototype.onAction = function(req) {
...
_photo_eda.prototype.onBlurFormField = function(i) {
	if (i.dom.value == "") i.dom.value = i.valdef;
};
_photo_eda.prototype.onClickBtnLastMore = function() {
	this.elLastMoreBtn.style.display = "none";
	this.elLastMoreWait.style.display = "block";
	this.actionListLastMore();
};
_photo_eda.prototype.onClickChbTerms = function() {
...
_photo_eda.prototype.onClickFormBtnSend = function() {
...
_photo_eda.prototype.onClickFormFileSelect = function() {
...
_photo_eda.prototype.onFocusFormField = function(i) {
	if (i.dom.value == i.valdef) i.dom.value = "";
};
_photo_eda.prototype.onGalleriaInstance = function(i) {
...
_photo_eda.prototype.onGalleriaReady = function() {
...
_photo_eda.prototype.onGalleryVote = function() {
};
_photo_eda.prototype.onPlayStop = function(e) {
	var uri = "";
	if (this.plCore._url.segments[0])
		uri = this.plCore._url.segments.join("/");
...
_photo_eda.prototype.onFBLiked = function(url) {
...
_photo_eda.prototype.onFBUnliked = function(url) {
	var p = this.plCore.urlParse(url);
	if (typeof p.params["id"] != "undefined") {
		var id = parseInt(p.params["id"], 10);
...
_photo_eda.prototype.onVKCount = function(id, r) {
